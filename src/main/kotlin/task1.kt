fun main(args: Array<String>) {
    ...
    val point = Point(readln().toInt(),readln().toInt())
    println("Введите координаты вершины (x1,y1)(x2,y2)(x3,y3) ")
    val triangle = Triangle(Point(readln().toInt(),readln().toInt()),Point(readln().toInt(),readln().toInt()),Point(readln().toInt(),readln().toInt()))
